...
class CompanyController extends Controller
{
    ...
    public function showCompanies(Company $company)
    {
        ...
        if($rol === 'ADMIN'){
            ...
            $company = DB::select("SELECT c.*, con.id as contact_id from users as u, companies as c, contacts as con where u.company_id = c.id
                and con.company_id=c.id and u.company_id = '$id_company' group by c.id, con.id");
        }
