                    ...
                    <div class="card wizard-card" data-color="orange" id="wizardProfile">
                        <form action="{{ route('addCompanyPost') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="wizard-header">
                               <h3>
                                   <b>WARRIORS LABS</b> REGISTER YOUR COMPANY <br>
                            ...
                            <div class="wizard-navigation">
                                <ul>
                                    ...
                                    <li><a href="#product" data-toggle="tab">Licensw WDStorages</a></li>
                                </ul>
                            </div>
                            <div class="tab-content">
                                <div class="tab-pane" id="company">
                                    <div class="row">
                                        <h4 class="info-text"> Let's start with the basic information about the comapny. <br> All field ara required</h4>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="nombre_compania" type="text" class="form-control" placeholder="Example: Warriors Labs SA de CV">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <div class="form-group">
                                                ...
                                                <input name="direccion" type="text" class="form-control" placeholder="Example: Pedra Santacilia num 24">
                                            </div>
                                        </div>
                                    </div>
                                </div>
