                            ...
                            <form class="form-horizontal form-label-left" novalidate action="<?php echo e(route('createUserPost')); ?>" method="post">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" style="text-transform: uppercase;" required>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" type="number" min="1" id="space" name="space" value="<?php echo e(old('space')); ?>" required>
