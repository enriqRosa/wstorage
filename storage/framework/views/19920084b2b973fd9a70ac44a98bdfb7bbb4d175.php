                            ...
                            <form class="form-horizontal form-label-left" novalidate action="<?php echo e(route('updateUserPost',$user->id)); ?>" method="post">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" type="text" id="name" name="name" value="<?php echo e($user->name); ?>" required>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" type="text" id="lastname" name="lastname" value="<?php echo e($user->apellidos); ?>" required>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" type="number" id="space" name="space" value="<?php echo e($user->tamano); ?>" required>
